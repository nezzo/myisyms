...
--
-- Структура таблицы `ips_user`
--

CREATE TABLE IF NOT EXISTS `ips_user` (
  `id` int(255) NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `module_sell`
--

CREATE TABLE IF NOT EXISTS `module_sell` (
  `id` int(255) NOT NULL AUTO_INCREMENT,
  `name_module` varchar(255) NOT NULL,
  `domen` varchar(255) NOT NULL,
  `key_modules` varchar(255) NOT NULL,
  `data` date NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `news_blogpost` (`id`, `name`, `meta-title`, `meta-description`, `description`, `keywords`, `data`, `time`) VALUES
(39, 'Мгновенная рассрочка  ПриватБанк (opencart 1.5)', 'Мгновенная рассрочка  ПриватБанк (opencart 1.5)', 'Модуль "Мгновенная рассрочка  ПриватБанк", позволяет оплачивать товар интернет-магазина с помощью расчетной функции "Мгновенная рассрочка" от  ПриватБанка.', '<p><img style="display: block; margin-left: auto; margin-right: auto;" src="../web/image/posts/module_privat_oplata_mgnovenna/logo-privatbank.jpg" width="320" height="61" /></p>\r\n<p>&nbsp; <span style="color: #000000;"><strong>Описание:</strong></span></p>\r\n<p><span style="color: #000000;">Модуль "Мгновенная рассрочка &nbsp;ПриватБанк", позволяет оплачивать товар интернет-магазина с помощью расчетной функции "Мгновенная рассрочка" от &nbsp;ПриватБанка.</span></p>\r\n<p>&nbsp;</p>\r\n<p><span style="color: #000000;"><strong>Скриншоты</strong>:</span></p>\r\n<p><span style="font-family: arial, helvetica, sans-serif; color: #000000;" data-blogger-escaped-style="background-color: white; font-family: &quot;arial&quot; , &quot;helvetica&quot; , sans-serif; font-size: 12px;">ID Shop: вводим id магазина тот что выдал ПриватБанк</span></p>\r\n<p><span style="color: #000000;">Password Shop: вводим пароль тот что выдал ПриватБанк.</span></p>\r\n<p><span style="color: #000000;"><img style="display: block; margin-left: auto; margin-right: auto;" src="../web/image/posts/module_privat_oplata_mgnovenna/privat_admin.jpg" width="640" height="294" />&nbsp;</span></p>\r\n<div class="separator"><span style="color: #000000;">При выборе &nbsp;платежа Privat Bank</span></div>\r\n<div class="separator">&nbsp;</div>\r\n<div class="separator"><span style="color: #000000;"><img style="display: block; margin-left: auto; margin-right: auto;" src="../web/image/posts/module_privat_oplata_mgnovenna/privat_payment.jpg" width="640" height="157" /></span></div>\r\n<div class="separator">&nbsp;</div>\r\n<div class="separator"><span style="color: #000000;">Появится окно с товаром, суммой расчета и сроком выбора кредитования.</span></div>\r\n<div class="separator">&nbsp;</div>\r\n<div class="separator"><span style="color: #000000;"><img style="display: block; margin-left: auto; margin-right: auto;" src="../web/image/posts/module_privat_oplata_mgnovenna/pay.jpg" width="640" height="155" />&nbsp;</span></div>\r\n<div class="separator"><span style="color: #000000;">После нажатия "оплата" &nbsp;будет перенаправлено в ПриватБанк &nbsp;для совершения сделки.</span></div>\r\n<div class="separator">&nbsp;</div>\r\n<div class="separator"><span style="color: #000000;"><img style="display: block; margin-left: auto; margin-right: auto;" src="../web/image/posts/module_privat_oplata_mgnovenna/1.jpg" width="640" height="299" />&nbsp;</span></div>\r\n<div class="separator"><span style="color: #000000;"><strong>Версия opencart</strong> : 1.5<br /><br />Для покупки модуля &nbsp;напишите в скайп &nbsp;xj-613d</span></div>', 'опенкарт, модули, мгновенная рассрочка ПриватБанк,opencart ,приватбанк оплата частями ,opencart premium templates ,шаблоны opencart бесплатно,интернет магазин opencart,бесплатные шаблоны, магазины оплата частями  ', '30-10-2016', 1477822292),
(40, 'Оплата частями ПриватБанк (opencart 1.5)', 'Оплата частями ПриватБанк (opencart 1.5)', 'Модуль "Оплата частями ПриватБанк", позволяет оплачивать товар интернет-магазина с помощью расчетной функции "Оплата частями" от  ПриватБанка.', '<p><img style="display: block; margin-left: auto; margin-right: auto;" src="../web/image/posts/module_privat_oplata_4astami/logo-privatbank.jpg" width="320" height="61" /></p>\r\n<p>&nbsp;<span style="color: #000000;"> <strong>Описание:</strong></span><br /><span style="color: #000000;">Модуль "Оплата частями ПриватБанк", позволяет оплачивать товар интернет-магазина с помощью расчетной функции "Оплата частями" от &nbsp;ПриватБанка.</span><br /><br /><span style="color: #000000;"><strong>Скриншоты</strong>:</span><br /><span style="color: #000000;">ID Shop: вводим id магазина тот что выдал ПриватБанк</span><br /><span style="color: #000000;">Password Shop: вводим пароль тот что выдал ПриватБанк.</span></p>\r\n<p><span style="color: #000000;"><img style="display: block; margin-left: auto; margin-right: auto;" src="../web/image/posts/module_privat_oplata_4astami/privat_admin.jpg" width="640" height="294" />&nbsp;</span></p>\r\n<p><span style="color: #000000;">При выборе &nbsp;платежа Privat Bank</span></p>\r\n<p><span style="color: #000000;"><img style="display: block; margin-left: auto; margin-right: auto;" src="../web/image/posts/module_privat_oplata_4astami/privat_payment.jpg" width="640" height="157" />&nbsp;</span></p>\r\n<p><span style="color: #000000;">Появится окно с товаром, суммой расчета и сроком выбора кредитования.</span></p>\r\n<p><span style="color: #000000;"><img style="display: block; margin-left: auto; margin-right: auto;" src="../web/image/posts/module_privat_oplata_4astami/pay.jpg" width="640" height="155" />&nbsp;</span></p>\r\n<p><span style="color: #000000;">После нажатия "оплата" &nbsp;будет перенаправлено в ПриватБанк &nbsp;для совершения сделки.</span></p>\r\n<p><span style="color: #000000;"><img style="display: block; margin-left: auto; margin-right: auto;" src="../web/image/posts/module_privat_oplata_4astami/1.jpg" width="640" height="299" />&nbsp;</span></p>\r\n<p><span style="color: #000000;"><strong>Версия opencart</strong> : 1.5<br /><br />Демонстрация данного модуля по <a href="http://chrono.com.ua/">ссылке</a><br /><br />Для покупки модуля &nbsp;напишите в скайп &nbsp;xj-613d</span></p>', 'опенкарт, модули, оплата частями ПриватБанк,opencart ,приватбанк оплата частями ,opencart premium templates ,шаблоны opencart бесплатно,интернет магазин opencart,бесплатные шаблоны, магазины оплата частями  ', '30-10-2016', 1477822283);
